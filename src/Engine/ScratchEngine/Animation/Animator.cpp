...
float ScratchEngine::Animator::SetAnimationIndex(int animIndex, bool loop)
{
...
bool ScratchEngine::Animator::SetAnimation(string animation,bool loop)
{
	...
	{
		SetAnimationIndex(it->second, loop);
		return true;
	}
